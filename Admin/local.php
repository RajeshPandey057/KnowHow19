...
<body>
                        ...
                        <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
                            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        <li><a href="../contact/evco.html">Event Co-ordinators</a></li>
                                        <li><a href="../contact/dev.html">Developers</a></li>
                                        <li><a href="../contact/contact.html">Send Query</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <div class="row mb-5 site-section">
                            <div class="col-12 ">
                                <h2 class="site-section-heading text-center">Editor's Pick</h2>
                            </div>
                        </div>
    ...
    <?php
      ...
      {
          echo "<div class='col-sm-6 col-md-4 col-lg-3 col-xl-2 item' data-aos='fade' data-src='$res[folder]' data-sub-html='<h4>$res[sname]</h4>'>
