                            ...
                            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="../vents/segacite.html">Segacite</a></li>
                                ...
                                <li class="has-children">
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="local.php">Editor's Pick</a></li>
                                    </ul>
                                </li>
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            <div class="row mb-5">
                                <div class="col-12 ">
                                    <h2 class="text-black h2 mb-0" style="text-align:center">The Results Haven't been declared yet , stay tuned</h2>
                                </div>
                            </div>
...
<?php
			...
			while($res=mysqli_fetch_assoc($result))
			{
				...
				if ($countrow==0) 
				{
	 			...
	 			echo"	
	 				<div class='col-md-4' data-aos='flip-up' data-aos-easing='linear' data-aos-duration='800'>
     					<div class='thumbnail'>
